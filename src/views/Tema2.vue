  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row
      ...
      .col-12.col-md-8.position-relative
        ...
        p.text-bold.clr_1 Existen referencias de empresas que mejoraron considerablemente su producción y posteriormente las ventas, solo con implementar un buen sistema de seguridad y salud en el trabajo.
    ...
    .row.mb-5  
      ...
      .col-12.col-md-5
        ...
        span.clr.text-bold Un partícula de polvo, por minúscula que parezca, puede ocasionar un mal funcionamiento de este, 
